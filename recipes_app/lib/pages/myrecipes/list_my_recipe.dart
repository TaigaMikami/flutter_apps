...
class _ListMyRecipeState extends State<ListMyRecipe> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      body: StreamBuilder(
        stream: Firestore.instance.collection('users').document(widget.id).collection('myrecipes').snapshots(),
                      ...
                      children: <Widget>[
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            ...
                            Firestore.instance
                              .collection('users/$userID/myrecipes')
                            ...
                            FirebaseStorage.instance
                              .ref()
                              .child(
                              'users/$userID/myrecipes/${document['name'].toString()}.jpg')
                              .delete()
                              .then((onValue) {
